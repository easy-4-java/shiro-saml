...
[![Java](https://img.shields.io/badge/Java-17-orange)](https://github.com/easy-4-java/shiro-saml) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](https://www.apache.org/licenses/LICENSE-2.0.txt)
...
| easy4j dependency | `io.github.easy4j:shiro-extension-spring` (`2.0.x.20260630-SNAPSHOT`) |
...
```groovy
implementation 'io.github.easy4j:shiro-saml-spring:2.0.x.20260630-SNAPSHOT'
```
